        ...
        <div className={styles.container}>
          <div className={styles.navWrapper}>
            ...
            <div className={styles.cartNavWrapper}>
              ...
              <Link to="/" className={"btn btn-orange " + styles.navButton}>Home</Link>
              <Link to="/about" className={"btn btn-orange " + styles.navButton}>About</Link>
              <Link to="/shop" className={"btn btn-orange " + styles.navButton}>Shop</Link>
              <Link to="/donations" className={"btn btn-orange " + styles.navButton}>Donate</Link>
              <Link to="/contact" className={"btn btn-orange " + styles.navButton}>Contact</Link>
              </div>
