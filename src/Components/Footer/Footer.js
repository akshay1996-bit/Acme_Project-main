      ...
      <div className={styles.footer}>
        <div className={styles.container}>
          <div className={styles.footerWrapper}>
            ...
            <div>
              <a href="http://twitter.com" className={styles.socialLink}>
              ...
              <a href="http://www.facebook.com" className={styles.socialLink}>
              ...
              <a href="http://www.instagram.com" className={styles.socialLink}>
          ...
          <div className={styles.footerBottomWrapper}>
              <div className={styles.footerSmall}>
                Made by <a href="http://twitter.com">
                  Akshay Ghodke
                </a>
                . © 2021.
              </div>
